...
public class SousTaskAdapter extends ArrayAdapter<SousTache> {

    public SousTaskAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<SousTache> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SousTache task = getItem(position);
